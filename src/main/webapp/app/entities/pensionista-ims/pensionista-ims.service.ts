...
type EntityResponseType = HttpResponse<IPensionistaIms>;
type EntityArrayResponseType = HttpResponse<IPensionistaIms[]>;

@Injectable({ providedIn: 'root' })
export class PensionistaImsService {
    private resourceUrl = SERVER_API_URL + 'api/pensionistas';

    constructor(private http: HttpClient) {}

    create(pensionista: IPensionistaIms): Observable<EntityResponseType> {
        const copy = this.convertDateFromClient(pensionista);
        return this.http
            .post<IPensionistaIms>(this.resourceUrl, copy, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertDateFromServer(res)));
    }

    update(pensionista: IPensionistaIms): Observable<EntityResponseType> {
        const copy = this.convertDateFromClient(pensionista);
        return this.http
            .put<IPensionistaIms>(this.resourceUrl, copy, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertDateFromServer(res)));
    }

    find(id: number): Observable<EntityResponseType> {
        return this.http
            .get<IPensionistaIms>(`${this.resourceUrl}/${id}`, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertDateFromServer(res)));
    }
    ...
    query(req?: any): Observable<EntityArrayResponseType> {
        ...
        return this.http
            .get<IPensionistaIms[]>(this.resourceUrl, { params: options, observe: 'response' })
    ...
    private convertDateFromClient(pensionista: IPensionistaIms): IPensionistaIms {
        const copy: IPensionistaIms = Object.assign({}, pensionista, {
    ...
    private convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
        res.body.forEach((pensionista: IPensionistaIms) => {
