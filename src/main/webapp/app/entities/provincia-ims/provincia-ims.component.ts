...
@Component({
    selector: 'jhi-provincia-ims',
    templateUrl: './provincia-ims.component.html'
})
export class ProvinciaImsComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.provinciaService
            ...
            .subscribe(
                (res: HttpResponse<IProvinciaIms[]>) => this.paginateProvincias(res.body, res.headers),
    ...
    trackId(index: number, item: IProvinciaIms) {
        return item.id;
    }
    ...
    private paginateProvincias(data: IProvinciaIms[], headers: HttpHeaders) {
