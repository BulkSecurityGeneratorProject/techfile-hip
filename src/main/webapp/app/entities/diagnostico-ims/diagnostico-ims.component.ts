...
@Component({
    selector: 'jhi-diagnostico-ims',
    templateUrl: './diagnostico-ims.component.html'
})
export class DiagnosticoImsComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.diagnosticoService
            ...
            .subscribe(
                (res: HttpResponse<IDiagnosticoIms[]>) => this.paginateDiagnosticos(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/diagnostico-ims'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: IDiagnosticoIms) {
        return item.id;
    }
    ...
    private paginateDiagnosticos(data: IDiagnosticoIms[], headers: HttpHeaders) {
