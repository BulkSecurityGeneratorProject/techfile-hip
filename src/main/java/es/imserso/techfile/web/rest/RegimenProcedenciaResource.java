...
public class RegimenProcedenciaResource {
    ...
    @Timed
    public ResponseEntity<List<RegimenProcedencia>> getAllRegimenProcedencias(Pageable pageable) {
        log.debug("REST request to get a page of RegimenProcedencias");
        Page<RegimenProcedencia> page = regimenProcedenciaRepository.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/regimen-procedencias");
