...
public class PerceptorResource {
    ...
    @Timed
    public ResponseEntity<Perceptor> createPerceptor(@Valid @RequestBody Perceptor perceptor) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<Perceptor> updatePerceptor(@Valid @RequestBody Perceptor perceptor) throws URISyntaxException {
