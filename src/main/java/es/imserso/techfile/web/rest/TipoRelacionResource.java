...
public class TipoRelacionResource {
    ...
    @Timed
    public ResponseEntity<List<TipoRelacion>> getAllTipoRelacions(Pageable pageable) {
        log.debug("REST request to get a page of TipoRelacions");
        Page<TipoRelacion> page = tipoRelacionRepository.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/tipo-relacions");
